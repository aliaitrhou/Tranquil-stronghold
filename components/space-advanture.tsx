...
import { Rocket, Star, Gem, Zap, Play } from 'lucide-react';
...
export default function SpaceAdventureGame({ handleClose }: { handleClose: () => void }) {
  ...
  return (
    <div className="absolute h-fit top-0 bottom-0 right-0 left-0 m-auto w-full max-w-2xl mx-auto py-5 px-6 space-y-6 bg-white backdrop-blur-xl rounded-3xl shadow-xl border border-black">
      <button onClick={handleClose} className='hover:bg-gray-300 rounded-full'>
